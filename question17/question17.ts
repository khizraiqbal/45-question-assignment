...
let guest: string[] = ['Salman', 'Taha', 'Ahmed',  'Hamza','Areeb',  'Ahsan','Iqbal',  'Wasiq']
...
console.log(`Sorry Dear ${removedguest} I can't invite you to dinner `)}

// Here we use "foreach function"  for printing message to guest who is invited
guest.forEach((guestinvite) => {

console.log(`Dear, ${guestinvite} you are invited for dinner`)
})
