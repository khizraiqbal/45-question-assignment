...
// Here we are using loop function 
// In loop "i" use for initialize number 
// "<" greater than sign use for stopping condition
// "i++" for updation

const usernames: string[] = ["Admin", "Eric", "Ahmed", "Ahsan", "Baber"];
